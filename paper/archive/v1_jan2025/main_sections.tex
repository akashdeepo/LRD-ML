...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=\textwidth]{figures/fig_preliminary_diagnostics.png}
    \caption{Preliminary Diagnostics: (a) Log-return distribution with normal and Student-$t$ fits, (b) Cross-stock volatility correlation matrix, (c) FIGARCH(1,$d$,1) fitted volatility for AAPL ($\hat{d}=0.318$), (d) QQ-plot showing departure from normality.}
...
\end{tabular}
\begin{tablenotes}\small
\item Notes: FIGARCH(1,$d$,1) estimated with AR(1) mean and normal errors. $d$ is the fractional integration parameter; $d \in (0, 0.5)$ indicates stationary long memory.
\end{tablenotes}
\end{table}
...
\newblock {\em Journal of Econometrics}, 74(1):3--30.
