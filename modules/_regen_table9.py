...
with open(fp, "w") as f:
    ...
    f.write(
        ...
        "realised variance. Under the proxy-robust QLIKE loss of "
        "\\citet{patton2011volatility} the GARCH(1,1) HLN-corrected DM "
        "statistic against Model~A narrows to $-2.80$ ($p=0.005$), versus "
        "$-20.30$ under MSE in the column above. Regime rows come from the Table 7 split at "
